...
function ProfileCard() {
  ...
  <div className="w-full max-w-md bg-black p-6 rounded-lg shadow-lg flex flex-col justify-between min-h-[90vh]">
    <div>
    ...
    <div className="text-center mt-8 text-gray-400">
      <p className='text-sm'>
      Made By <a href="https://saibende.tech" className="text-blue-400">saibende.tech</a>
      <br />
      Get Your Own Public Link Profile at <a href="https://sggs.me" className="text-blue-400">sggs.me</a>
      </p>
